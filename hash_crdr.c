 ...
 * @arg_list: argumenet list given by user, generally gives which
 * directory to change to
 * @envp: environemental variable linked list to get current working
 * directory and also to update the variables PWD and OLDPWD
 *
