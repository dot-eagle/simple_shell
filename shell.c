 ...
 * commands to execute.
 * Handles ; && and || Will advance buffer to next command
 *
 ...
 * @b: buffer structure
 * Description: Small helper function for function more_cmds.
 * Advances the buffer point past command control characters.
 */
